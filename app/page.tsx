...
interface Material { id: string; name: string; density: number; unit: string; }
const MATERIALE_DEFAULT: Material[] = [
...
// ===== UI COMPONENTS =====
interface InputProps { label?: string; value: string | number; onChange: (v: any) => void; type?: string; suffix?: string; small?: boolean; disabled?: boolean; }
const Input = ({ label, value, onChange, type = "text", suffix, small, disabled }: InputProps) => (
